...
export const MOCK_PHOTOS: Record<string, Photo[]> = {
  "1": [
    { id: "p1", album_id: "1", image_url: "https://images.unsplash.com/photo-1583417319070-4a69db38a482?auto=format&w=1200&q=85", thumbnail_url: "", title: "Nhà Thờ Đức Bà rực rỡ", description: "Góc nhìn từ trên cao", alt_text: "Saigon Notre-Dame Basilica at night", display_order: 0, created_at: "2026-06-01T20:05:00.000Z" },
    { id: "p2", album_id: "1", image_url: "https://images.unsplash.com/photo-1549488344-1f9b8d2bd1f3?auto=format&w=1200&q=85", thumbnail_url: "", title: "Nhịp sống Nguyễn Huệ", description: "Phố đi bộ náo nhiệt", alt_text: "Nguyen Hue walking street", display_order: 1, created_at: "2026-06-01T20:10:00.000Z" },
    { id: "p3", album_id: "1", image_url: "https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&w=1200&q=85", thumbnail_url: "", title: "Bến Bạch Đằng lung linh", description: "Ánh đèn phản chiếu sông Sài Gòn", alt_text: "Bach Dang pier", display_order: 2, created_at: "2026-06-01T20:15:00.000Z" },
    { id: "p4", album_id: "1", image_url: "https://images.unsplash.com/photo-1519904981063-b0cf448d479e?auto=format&w=1200&q=85", thumbnail_url: "", title: "Phố đêm Sài Gòn", description: "Góc phố về khuya", alt_text: "Saigon street at night", display_order: 3, created_at: "2026-06-01T20:20:00.000Z" },
  ],
  "2": [
    { id: "p5", album_id: "2", image_url: "https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?auto=format&w=1200&q=85", thumbnail_url: "", title: "Cốc cà phê sữa đá buổi sáng", description: "Hương vị Sài Gòn", alt_text: "Vietnamese iced coffee", display_order: 0, created_at: "2026-06-10T08:35:00.000Z" },
    { id: "p6", album_id: "2", image_url: "https://images.unsplash.com/photo-1498804103079-a6351b050096?auto=format&w=1200&q=85", thumbnail_url: "", title: "Góc trò chuyện", description: "Câu chuyện bên ly cà phê", alt_text: "People chatting at cafe", display_order: 1, created_at: "2026-06-10T08:40:00.000Z" },
  ],
  "3": [
    { id: "p7", album_id: "3", image_url: "https://images.unsplash.com/photo-1568992687947-868a62a9f521?auto=format&w=1200&q=85", thumbnail_url: "", title: "Mặt tiền Bưu điện Thành phố", description: "Kiến trúc Phục Hưng tuyệt đẹp", alt_text: "Saigon Central Post Office", display_order: 0, created_at: "2026-06-15T15:50:00.000Z" },
    { id: "p8", album_id: "3", image_url: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?auto=format&w=1200&q=85", thumbnail_url: "", title: "Nhà thờ Đức Bà", description: "Công trình biểu tượng Sài Gòn", alt_text: "Notre-Dame Cathedral Basilica", display_order: 1, created_at: "2026-06-15T15:55:00.000Z" },
    { id: "p9", album_id: "3", image_url: "https://images.unsplash.com/photo-1621155346337-1d19476ba7b0?auto=format&w=1200&q=85", thumbnail_url: "", title: "Bên trong Bưu điện", description: "Trần vòm cao và cổ kính", alt_text: "Post office interior", display_order: 2, created_at: "2026-06-15T16:00:00.000Z" },
  ],
  "4": [
    { id: "p10", album_id: "4", image_url: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&w=1200&q=85", thumbnail_url: "", title: "Bãi Dài hoàng hôn", description: "Cát trắng, nắng vàng", alt_text: "Bai Dai sunset", display_order: 0, created_at: "2026-05-20T10:05:00.000Z" },
    { id: "p11", album_id: "4", image_url: "https://images.unsplash.com/photo-1519046904884-53103b34b206?auto=format&w=1200&q=85", thumbnail_url: "", title: "Sóng vỗ bờ cát", description: "Nhịp sóng êm đềm", alt_text: "Waves on Phu Quoc beach", display_order: 1, created_at: "2026-05-20T10:10:00.000Z" },
    { id: "p12", album_id: "4", image_url: "https://images.unsplash.com/photo-1613939017364-f160eee2eb1e?auto=format&w=1200&q=85", thumbnail_url: "", title: "Thuyền đánh cá", description: "Khung cảnh bình yên", alt_text: "Fishing boats", display_order: 2, created_at: "2026-05-20T10:15:00.000Z" },
  ],
  "5": [
    { id: "p13", album_id: "5", image_url: "https://images.unsplash.com/photo-1506806732259-39c2d0268443?auto=format&w=1200&q=85", thumbnail_url: "", title: "Chợ nổi lúc bình minh", description: "Nhộn nhịp thuyền ghe", alt_text: "Floating market sunrise", display_order: 0, created_at: "2026-04-15T05:05:00.000Z" },
    { id: "p14", album_id: "5", image_url: "https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?auto=format&w=1200&q=85", thumbnail_url: "", title: "Trái cây miệt vườn", description: "Sắc màu nhiệt đới", alt_text: "Tropical fruits on boat", display_order: 1, created_at: "2026-04-15T05:10:00.000Z" },
  ],
  "6": [
    { id: "p15", album_id: "6", image_url: "https://images.unsplash.com/photo-1518834107812-67b0b7c58434?auto=format&w=1200&q=85", thumbnail_url: "", title: "Bước nhảy hoàn hảo", description: "Khoảnh khắc đỉnh cao", alt_text: "Ballet dancer jump", display_order: 0, created_at: "2026-03-10T18:05:00.000Z" },
    { id: "p16", album_id: "6", image_url: "https://images.unsplash.com/photo-1508807526345-15e9b5f4eaff?auto=format&w=1200&q=85", thumbnail_url: "", title: "Duyên dáng", description: "Đường cong nghệ thuật", alt_text: "Ballet pose", display_order: 1, created_at: "2026-03-10T18:10:00.000Z" },
  ]
};
