...
export default function AboutPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 text-center">
      <ScrollReveal>
        <div className="w-32 h-32 rounded-full bg-secondary mx-auto mb-6 flex items-center justify-center overflow-hidden border border-border/40">
        ...
        <p className="text-muted-foreground max-w-lg mx-auto mb-8 leading-relaxed text-sm sm:text-base">{settings.author_bio}</p>
      </ScrollReveal>
      ...
      <ScrollReveal delay={200}>
        <Card className="p-8 rounded-3xl text-left border border-border/40 shadow-sm bg-card">
          <h2 className="text-xl font-semibold mb-4 text-center">Về Nhiếp Ảnh Số</h2>
          <p className="text-muted-foreground leading-relaxed text-sm sm:text-base">{settings.site_description}</p>
        </Card>
      </ScrollReveal>
    </div>
  );
